    ...
    txt = open("/Users/zehranurkolsuz/Desktop/zehrapythonklasor/zehrapython.txt","r",encoding="utf-8")
    oku = txt.read()
 ...
 cıktı=open("/Users/zehranurkolsuz/Desktop/zehrapythonklasor/sonuc.txt","w",encoding="utf-8")
